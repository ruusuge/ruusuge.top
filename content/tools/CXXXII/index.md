...
<div class="cxxxii-container">
  ...
  <div class="controls">
    <button id="generateBtn" class="button button-primary">画像を生成</button>
    <div class="scale-options">
      <label for="scaleSelect">画像を拡大:</label>
      ...
      <button id="downloadBtn" class="button button-secondary" disabled>画像をダウンロード</button>
    </div>
  </div>
</div>
...
<script>
  ...
  function generateImage() {
    ...
    if (!fontImage) {
      showStatus('フォントがまだ読み込まれていません！', 'error');
      return;
    }
